...
RESULTS_ROOT = "./results/6.3-Source_Activation_CrossBlock-2"
...
if __name__ == "__main__":
    ...
    if args.prepare:
        ...
        for subject in os.listdir(SUBJECTS_DIR):
            ...
            stc_b2_sub, stc_b3_sub = None, None
        ...
        del stc_b2_sub, stc_b3_sub
        del stc_b2_f, stc_b3_f, epochs, morph, inv
        del evoked_b2_f, evoked_b3_f
        gc.collect()
